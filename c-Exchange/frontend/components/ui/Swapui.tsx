                    ...
                    <div className="flex flex-col text-white flex-1 gap-3">
                        ...
                        {activeTab === "buy" && (
                                <div className="mt-4">
                                    ...
                                    <button
                                    type="button"
                                    className="cursor-pointer font-semibold focus:ring-blue-200 focus:outline-none text-center h-12 rounded-xl text-base px-4 py-2 my-4 bg-green-500 text-white active:scale-98 w-full hover:bg-green-400 "
                                    >
                                    Buy
                                    </button>
                                </div>
                        ...
                        {activeTab === "sell" && (
                                <div className="mt-4">
                                    ...
                                    <button
                                    type="button"
                                    className="cursor-pointer font-semibold focus:ring-blue-200 focus:outline-none text-center h-12 rounded-xl text-base px-4 py-2 my-4 bg-red-500 text-white active:scale-98 w-full hover:bg-red-400"
                                    >
                                    Sell
                                    </button>
                                </div>
